...
import com.champsoft.vrms2330241.modules.registration.api.dto.*;
import com.champsoft.vrms2330241.modules.registration.api.mapper.RegistrationApiMapper;
import com.champsoft.vrms2330241.modules.registration.application.service.RegistrationCrudService;
import com.champsoft.vrms2330241.modules.registration.application.service.RegistrationOrchestrator;
...
public class RegistrationController {
    ...
    public ResponseEntity<EntityModel<RegistrationResponse>> register(@RequestBody @Valid RegisterVehicleRequest req) {
        var reg = orchestrator.register(req.vehicleId(), req.ownerId(), req.agentId());
